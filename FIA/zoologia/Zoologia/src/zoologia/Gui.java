...
public class Gui extends JFrame {
    ...
    String path = new java.io.File("prolog/" + archivo).getAbsolutePath().replace("\\", "/");
    this.q1 = new Query("consult('" + path + "')");
    System.out.println("consult('" + path + "') " + (this.q1.hasSolution() ? "OK" : "FAIL"));
}
