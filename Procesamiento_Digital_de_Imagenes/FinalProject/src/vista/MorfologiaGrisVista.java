...
public class MorfologiaGrisVista extends JFrame {
    ...
    public static final String[] OPERACIONES = {
        ...
        "Erosion Gris", "Dilatacion Gris", "Apertura Gris", "Clausura Gris"
    };

    public MorfologiaGrisVista() {
        super("Practica 11 - Morfologia en Niveles de Gris");
        setSize(1100, 650);
    ...
    public void mostrarResultado(BufferedImage img) { ImageUtils.displayOn(lblResultado, img, 450, 450); }
}
