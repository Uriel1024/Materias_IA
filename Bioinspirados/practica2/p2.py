...
#se cambia el 1 por para que reciba 2 argumentos
...
#el codigo de sajoni para crear la tupla (al parecer si es la mejor opcion)
points_xy = [
    (x/10. , y/10.)
    for x in range(-25,25,5)
    for y in range(-25,25,5)
]
"""
points_xy = [
    (x/10. , y/10.)
...
toolbox.register("evaluate", evalSymbReg, points=points_xy)
